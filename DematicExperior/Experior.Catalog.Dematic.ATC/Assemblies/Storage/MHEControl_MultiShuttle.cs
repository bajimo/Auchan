...
namespace Experior.Catalog.Dematic.ATC.Assemblies.Storage
{
    ...
    class MHEControl_MultiShuttle : MHEControl
    {
        ...
        [Category("ATC Telegrams")]
        [DisplayName("Multi PS Telegrams")]
        [Description("True = Send Multiple Grouped telegrams for 2 loads at the pick station, False = Send single message per load at the pick station")]
        public bool MultiPSTelegrams
        {
            get { return multiShuttleATCInfo.multiPSTelegram; }
            set
            {
                multiShuttleATCInfo.multiPSTelegram = value;
            }
        }
    ...
    public class MultiShuttleATCInfo : ProtocolInfo
    {
        public int numOfBays;
        public int locationsPerBay;
        public bool multiPSTelegram = true;
    }
}
