...
namespace Experior.Catalog.Dematic.DatcomUK.Assemblies
{
    ...
    {
        private CommPointDatcomInfo commPointDatcomInfo;
        ...
        //    if (CallForwardArrivalMessage && CallForwardType == CommPointDatcomInfo.CallForwardTypes.OnArrival)
        //    {
        ...
        //        if (CallForwardArrivalMessage && CallForwardType == CommPointDatcomInfo.CallForwardTypes.OnLeaving)
        ...
        //[PropertyOrder(6)]
        //[PropertyAttributesProvider("DynamicPropertyCallForwardPoint")]
        //public CommPointDatcomInfo.CallForwardTypes CallForwardType
        //{
        //    get
        //    {
        ...
        public CommPointDatcomInfo.CommPointTypes CommPointType
        {
    ...
    [Serializable]
    [XmlInclude(typeof(CommPointDatcomInfo))]
    public class CommPointDatcomInfo : ProtocolInfo
    {
        public enum CommPointTypes 
        { 
            None, 
            Arrival_Point, 
            //Arrival_Delay, 
        ...
        public CommPointTypes commPointType = CommPointTypes.None;
