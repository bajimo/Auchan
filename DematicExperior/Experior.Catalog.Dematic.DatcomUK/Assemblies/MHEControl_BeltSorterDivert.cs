...
namespace Experior.Catalog.Dematic.DatcomUK.Assemblies
{
    ...
    {
        private BeltSorterDivertDatcomInfo divertDatcomInfo;
        ...
        #region Constructors
        public MHEControl_BeltSorterDivert(BeltSorterDivertDatcomInfo info, BeltSorterDivert sorterDivert)
        {
    ...
    [Serializable]
    [XmlInclude(typeof(BeltSorterDivertDatcomInfo))]
    public class BeltSorterDivertDatcomInfo : ProtocolInfo
    {
